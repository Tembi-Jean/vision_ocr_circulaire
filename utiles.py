...
def main():
    ...
    # Utilisation de la fonction process_image pour obtenir l'image tournée et le tableau des cercles détectés
    rotated, circles = process_image("produit_basler.png")

    # Utilisation de la fonction get_roi pour obtenir la ROI
    roi = get_roi(rotated)
